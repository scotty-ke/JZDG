...
@class ZJD_StarEvaluateView;

@protocol ZJD_StarEvaluateViewDelegate <NSObject>

// 具体方法
- (void)starView:(ZJD_StarEvaluateView *)view andStarIndex:(NSInteger)index;
...
@property (nonatomic,weak) id<ZJD_StarEvaluateViewDelegate> delegate;
