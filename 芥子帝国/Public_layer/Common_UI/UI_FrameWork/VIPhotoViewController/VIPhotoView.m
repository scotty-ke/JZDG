...
- (void)setupGestureRecognizer
{
    ...
    UILongPressGestureRecognizer *longPressGestureRecognizer = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(longPressTapHandler:)];
...
- (void)longPressTapHandler:(UILongPressGestureRecognizer *)recognizer {
...
//        APPLOG(@"end");
    ...
    if (recognizer.state == UIGestureRecognizerStateBegan && [self.photoViewDelegate respondsToSelector:@selector(photoViewLongPressTap:)]) {
        [self.photoViewDelegate photoViewLongPressTap:self.image];
    }
}
